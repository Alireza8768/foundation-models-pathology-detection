# train_retinanet_virchow_midogpp.py

"""
Training script for RetinaNet with Virchow backbone on MIDOG++.
...
def main():
    ...
    cfg_path = str(project_root / 'configs/retinanet_virchow_midogpp.py')
