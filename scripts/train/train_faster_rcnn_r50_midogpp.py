# train_faster_rcnn_r50_midogpp.py

"""
Training script for Faster R-CNN with Restnet50 backbone on MIDOG++.
...
def main():
    ...
    cfg_path = str(project_root / 'configs/faster_rcnn_r50_midogpp.py')
