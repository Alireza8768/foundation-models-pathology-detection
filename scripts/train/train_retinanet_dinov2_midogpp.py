# train_retinanet_dinov2_midogpp.py

"""
Training script for RetinaNet with Dino v2 Giant backbone on MIDOG++.
...
def main():
    ...
    cfg_path = str(project_root / 'configs/retinanet_dinov2_midogpp.py')
