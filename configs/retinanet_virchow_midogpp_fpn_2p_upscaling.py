# config/retinanet_virchow_midogpp_fpn_2p_upscaling.py
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file='data/oco_annotations/patches_1008/midogpp_test.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = './outputs/work_dirs/retinanet_virchow_1008_upscaleP4_40Epochs'
