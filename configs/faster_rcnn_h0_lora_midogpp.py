# configs/faster_rcnn_h0_lora_midogpp.py
...
train_dataloader = dict(
    batch_size=4,          # FasterRCNN braucht oft mehr VRAM -> lieber kleiner starten
    num_workers=4,
...
resume = False
work_dir = './outputs/work_dirs/faster_rcnn_h0_lora_6_1008_40epochs'
